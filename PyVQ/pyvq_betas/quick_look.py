...
def plot_greens(shear_normal='shear', greens_fname='model1_greens_3000.h5', fnum=0, do_sort=True):
	...
	del(g_data)
	#
def plot_greens_hist(shear_normal='shear', greens_fname='model1_greens_3000.h5', fnum=0, n_bins=1000, **hist_kwargs):
	'''
	...
	#
#
def greens_consistency_check(greens_fname='model1_greens_3000.h5', shear_normal='shear', n_bins=1000, fnum=0, **hist_kwargs):
	'''
